...
class Record extends Base {
  ...
  getRecordByRecordId (id) {
    return knex(this.table).join('user', 'user.userId', '=', 'record.userId').select('userName', 'recordId', 'recordText', 'recordImage', 'record.userId', 'time', 'billId').where('recordId', '=', id)
  }
